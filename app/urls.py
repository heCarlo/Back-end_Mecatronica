...
from app.views.sensors.receiveSensorDataView import ReceiveSensorDataGetByIdView, ReceiveSensorDataPostView, ReceiveSensorDataGetView, ReceiveSensorDataPutView, ReceiveSensorDataDeleteView
